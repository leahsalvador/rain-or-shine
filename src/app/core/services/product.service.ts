...
export class ProductService {
  ...
  initColor(){
    this.colors = {
      ...
      // tslint:disable-next-line:max-line-length
      elastofloor : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'EF 1010', dark: true}, {hex: '#E1CAA8', file_no: '02', name: 'Beige', code: 'EF 1993', dark: true}, {hex: '#B2BEBE', file_no: '03', name: 'Gray', code: 'EF 1126', dark: true}, {hex: '#E8C11E', file_no: '04', name: 'Yellow', code: 'EF 5050', dark: true}, {hex: '#D22127', file_no: '05', name: 'Red', code: 'EF 2611', dark: true}, {hex: '#A94E2F', file_no: '06', name: 'Tile Red', code: 'EF 4030', dark: true}, {hex: '#1E442B', file_no: '07', name: 'Green', code: 'EF 9010', dark: true}, {hex: '#30469C', file_no: '08', name: 'Blue', code: 'EF 7010', dark: true}, {hex: '#231F20', file_no: '09', name: 'Black', code: 'EF 1130', dark: false}],
      // tslint:disable-next-line:max-line-length
