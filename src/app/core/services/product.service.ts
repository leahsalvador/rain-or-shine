...
export class ProductService {
  ...
  initColor(){
    this.colors = {
      // tslint:disable-next-line:max-line-length
      main_colors : [{hex: '#FBF8F3', file_no: '01', name: 'Gentle Touch', code: 'ROS 530', dark: true}, {hex: '#FCEFEC', file_no: '02', name: 'Romance', code: 'ROS 175', dark: true}, {hex: '#FFFCEB', file_no: '03', name: 'Bridal Gown', code: 'ROS 559', dark: true}, {hex: '#FFFBE1', file_no: '04', name: 'Milk', code: 'ROS 809', dark: true}, {hex: '#FFF4DE', file_no: '05', name: 'Tulip', code: 'ROS 629', dark: true}, {hex: '#FEF6D9', file_no: '06', name: 'Light Apricot', code: 'ROS 638', dark: true}, {hex: '#F4E9C9', file_no: '07', name: 'Sugarcane', code: 'ROS 853', dark: true}, {hex: '#F8EECB', file_no: '08', name: 'China White', code: 'ROS 818', dark: true}, {hex: '#F4E2BA', file_no: '09', name: 'Coconut', code: 'ROS 739', dark: true}, {hex: '#E2CDA0', file_no: '10', name: 'Cappuccino', code: 'ROS 623', dark: true}, {hex: '#FEE7A7', file_no: '11', name: 'Ivory', code: 'ROS 862', dark: true}, {hex: '#FEF3A7', file_no: '12', name: 'Red Earth', code: 'ROS 285', dark: true}, {hex: '#FDD883', file_no: '13', name: 'Honey Bun', code: 'ROS 239', dark: true}, {hex: '#FDEF88', file_no: '14', name: 'Citrus', code: 'ROS 513', dark: true}, {hex: '#E9E081', file_no: '15', name: 'Mango', code: 'ROS 635', dark: true}, {hex: '#F6DA6F', file_no: '16', name: 'French Vanilla', code: 'ROS 619', dark: true}, {hex: '#FED55F', file_no: '17', name: 'Golden Butter', code: 'ROS 678', dark: true}, {hex: '#DFBC6A', file_no: '18', name: 'Sunshine Yellow', code: 'ROS 206', dark: true}, {hex: '#FEDD4F', file_no: '19', name: 'Cheese', code: 'ROS 333', dark: true}, {hex: '#FEE44B', file_no: '20', name: 'Happy Days', code: 'ROS 618', dark: true}, {hex: '#FCC25C', file_no: '21', name: 'Sweet Corn', code: 'ROS 808', dark: true}, {hex: '#F5AE64', file_no: '22', name: 'Boracay', code: 'ROS 339', dark: true}, {hex: '#FBC795', file_no: '23', name: 'Irvine Peach', code: 'ROS 313', dark: true}, {hex: '#F9BD9E', file_no: '24', name: 'Angelina', code: 'ROS 363', dark: true}, {hex: '#F49171', file_no: '25', name: 'Amber Rose', code: 'ROS 350', dark: true}, {hex: '#F69C70', file_no: '26', name: 'Red Earth', code: 'ROS 285', dark: true}, {hex: '#E28D68', file_no: '27', name: 'Bittersweet', code: 'ROS 777', dark: true}, {hex: '#E27346', file_no: '28', name: 'Sunkiss', code: 'ROS 247', dark: true}, {hex: '#F27E41', file_no: '29', name: 'Orange Twist', code: 'ROS 203', dark: true}, {hex: '#F09E20', file_no: '30', name: 'Gold Rush', code: 'ROS 529', dark: true}, {hex: '#F68C1E', file_no: '31', name: 'Lucky Orange', code: 'ROS 888', dark: true}, {hex: '#EFD4B7', file_no: '32', name: 'Candy Turf', code: 'ROS 367', dark: true}, {hex: '#D4AE89', file_no: '33', name: 'Natural Tan', code: 'ROS 359', dark: true}, {hex: '#C1966C', file_no: '34', name: 'Mocha', code: 'ROS 186', dark: true}, {hex: '#A88164', file_no: '35', name: 'Safari Brown', code: 'ROS 538', dark: true}, {hex: '#875942', file_no: '36', name: 'Terra Cotta', code: 'ROS 101', dark: true}, {hex: '#724A30', file_no: '37', name: 'Maple', code: 'ROS 965', dark: true}, {hex: '#8C4122', file_no: '38', name: 'Red Earth', code: 'ROS 285', dark: true}, {hex: '#8B2F22', file_no: '39', name: 'Victory Red', code: 'ROS 889', dark: true}, {hex: '#6E2A15', file_no: '40', name: 'Tile Red', code: 'ROS 302', dark: true}, {hex: '#351D13', file_no: '41', name: 'Choco Brown', code: 'ROS 633', dark: false}, {hex: '#F9BEBA', file_no: '42', name: 'Nicole Pink', code: 'ROS 223', dark: true}, {hex: '#F5A5A4', file_no: '43', name: 'Princess', code: 'ROS 813', dark: true}, {hex: '#D1747C', file_no: '44', name: 'Foxy', code: 'ROS 393', dark: true}, {hex: '#BE535B', file_no: '45', name: 'Watermelon', code: 'ROS 168', dark: true}, {hex: '#E65041', file_no: '46', name: 'True Orange', code: 'ROS 252', dark: true}, {hex: '#C52A28', file_no: '47', name: 'Oh So Red', code: 'ROS 298', dark: true}, {hex: '#B92928', file_no: '48', name: 'Vibrant Ruby', code: 'ROS 823', dark: true}, {hex: '#D8D1A5', file_no: '49', name: 'Antique White', code: 'ROS 270', dark: true}, {hex: '#A69A82', file_no: '50', name: 'Light Biege', code: 'ROS 353', dark: true}, {hex: '#A2987F', file_no: '51', name: 'Beige', code: 'ROS 901', dark: true}, {hex: '#83796D', file_no: '52', name: 'Arcadia', code: 'ROS 757', dark: true}, {hex: '#6E7275', file_no: '53', name: 'Stone Gray', code: 'ROS 115', dark: true}, {hex: '#EDF6F3', file_no: '54', name: 'Touch of Gray', code: 'ROS 171', dark: true}, {hex: '#EDF6F3', file_no: '55', name: 'Snow', code: 'ROS 233', dark: true}, {hex: '#EBF6F2', file_no: '56', name: 'Faith', code: 'ROS 781', dark: true}, {hex: '#AEB8B0', file_no: '57', name: 'Neutral Gray', code: 'ROS 883', dark: true}, {hex: '#8CA6B7', file_no: '58', name: 'Powder Blue', code: 'ROS 389', dark: true}, {hex: '#E5F0D0', file_no: '59', name: 'Serenity', code: 'ROS 381', dark: true}, {hex: '#CAE5D6', file_no: '60', name: 'Faraway Blue', code: 'ROS 370', dark: true}, {hex: '#BBDFC5', file_no: '61', name: 'Cool Water', code: 'ROS 928', dark: true}, {hex: '#B5DAA4', file_no: '62', name: 'Cool Mint', code: 'ROS 933', dark: true}, {hex: '#9CD19B', file_no: '63', name: 'My Way', code: 'ROS 368', dark: true}, {hex: '#B6C67D', file_no: '64', name: 'Lime', code: 'ROS 138', dark: true}, {hex: '#C8DD76', file_no: '65', name: 'Fresh Mint', code: 'ROS 829', dark: true}, {hex: '#D8E265', file_no: '66', name: 'Pistachio', code: 'ROS 238', dark: true}, {hex: '#B1D362', file_no: '67', name: 'Temptation', code: 'ROS 518', dark: true}, {hex: '#95BA74', file_no: '68', name: 'Archer Green', code: 'ROS 728', dark: true}, {hex: '#338A43', file_no: '69', name: 'Bright Green', code: 'ROS 728', dark: true}, {hex: '#317157', file_no: '70', name: 'Asian Gree', code: 'ROS 929', dark: true}, {hex: '#1D5538', file_no: '71', name: 'Baguio Green', code: 'ROS 701', dark: false}, {hex: '#B7DCD4', file_no: '72', name: 'Tiffany', code: 'ROS 835', dark: true}, {hex: '#62BEAF', file_no: '73', name: 'Aquamarine', code: 'ROS 505', dark: true}, {hex: '#45767A', file_no: '74', name: 'Maritime Blue', code: 'ROS 735', dark: true}, {hex: '#72CDE0', file_no: '75', name: 'Blue Heaven', code: 'ROS 218', dark: true}, {hex: '#62C1E1', file_no: '76', name: 'Aqua Blue', code: 'ROS 587', dark: true}, {hex: '#428ECC', file_no: '77', name: 'Blue Denim', code: 'ROS 501', dark: true}, {hex: '#00A5DF', file_no: '78', name: 'Blue Ocean', code: 'ROS 723', dark: true}, {hex: '#00739A', file_no: '79', name: 'China Blue', code: 'ROS 762', dark: true}, {hex: '#005689', file_no: '80', name: 'Royal Blue', code: 'ROS 301', dark: true}, {hex: '#AECDE9', file_no: '81', name: 'Lavender', code: 'ROS 309', dark: true}, {hex: '#8F7BB8', file_no: '82', name: 'Violet', code: 'ROS 801', dark: true}, {hex: '#61217F', file_no: '83', name: 'Royal Purple', code: 'ROS 909', dark: true}, {hex: '#501268', file_no: '84', name: 'Color Purple', code: 'ROS 999', dark: true}, {hex: '#231F20', file_no: '999', name: 'Black', code: 'ROS 111', dark: false}],
      // tslint:disable-next-line:max-line-length
      deck_seal : [{hex: '#FFFFFF', file_no: '01', name: 'Deck White', code: 'DK 100', dark: true}, {hex: '#D6D6CE', file_no: '02', name: 'Deck Gray', code: 'DK 112', dark: true}, {hex: '#E2CDB2', file_no: '03', name: 'Deck Beige', code: 'DK 131', dark: true}, {hex: '#E6C331', file_no: '04', name: 'Deck Yellow', code: 'DK 624', dark: true}, {hex: '#D2191F', file_no: '05', name: 'Deck Red', code: 'DK 219', dark: true}, {hex: '#8D4A2D', file_no: '06', name: 'Deck Brown', code: 'DK 402', dark: true}, {hex: '#214A22', file_no: '07', name: 'Deck Green', code: 'DK 909', dark: false}, {hex: '#263F81', file_no: '08', name: 'Deck Blue', code: 'DK 722', dark: true}, {hex: '#0F100A', file_no: '09', name: 'Deck Black', code: 'DK 116', dark: false}],
      // tslint:disable-next-line:max-line-length
      classic: [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'CL 100', dark: true}, {hex: '#FDF5F2', file_no: '02', name: 'Ceramic White', code: 'CL 118', dark: true}, {hex: '#FCF7E4', file_no: '03', name: 'Satin White', code: 'CL 123', dark: true}, {hex: '#F6EFD8', file_no: '04', name: 'White Smoke', code: 'CL 189', dark: true}, {hex: '#E6E1C4', file_no: '05', name: 'Tropical Sand', code: 'CL 157', dark: true}, {hex: '#F0E1C0', file_no: '06', name: 'Boardwalk', code: 'CL 196', dark: true}, {hex: '#E6DDB4', file_no: '07', name: 'Long Beach', code: 'CL 161', dark: true}, {hex: '#FDEF88', file_no: '08', name: 'Warm Yellow', code: 'CL 527', dark: true}, {hex: '#FEE481', file_no: '09', name: 'Yellowstone', code: 'CL 575', dark: true}, {hex: '#FEE52E', file_no: '10', name: 'Sunflower', code: 'CL 567', dark: true}, {hex: '#F38548', file_no: '11', name: 'Four Seasons', code: 'CL 330', dark: true}, {hex: '#91643B', file_no: '12', name: 'Brown Leather', code: 'CL 655', dark: true}, {hex: '#FAD1B9', file_no: '13', name: 'Pink Salmon', code: 'CL 318', dark: true}, {hex: '#DDB995', file_no: '14', name: 'Natural Wood', code: 'CL 173', dark: true}, {hex: '#EFA9A3', file_no: '15', name: 'Pink Blush', code: 'CL 208', dark: true}, {hex: '#D2593E', file_no: '16', name: 'Lipstick', code: 'CL 383', dark: true}, {hex: '#BDBDBB', file_no: '17', name: 'Hard Rock', code: 'CL 103', dark: true}, {hex: '#C7D9F1', file_no: '18', name: 'Frozen', code: 'CL 789', dark: true}, {hex: '#1A6BAD', file_no: '19', name: 'Smart Blue', code: 'CL 709', dark: true}, {hex: '#B5DAA4', file_no: '20', name: 'Green Meadow', code: 'CL 925', dark: true}, {hex: '#015730', file_no: '21', name: 'Dollar Green', code: 'CL 903', dark: false}],
      // tslint:disable-next-line:max-line-length
      dirt_shield : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'DS 100', dark: true}, {hex: '#FFFCE9', file_no: '02', name: 'Pristine', code: 'DS 117', dark: true}, {hex: '#F8E6C0', file_no: '03', name: 'Beachfront', code: 'DS 155', dark: true}, {hex: '#FFEBB6', file_no: '04', name: 'Morning Sun', code: 'DS 593', dark: true}, {hex: '#D5C8A5', file_no: '05', name: 'Khaki', code: 'DS 190', dark: true}, {hex: '#F1C97A', file_no: '06', name: 'Peanut Butter', code: 'DS 357', dark: true}, {hex: '#C0A975', file_no: '07', name: 'Good Earth', code: 'DS 181', dark: true}, {hex: '#786346', file_no: '08', name: 'Arabica', code: 'DS 675', dark: true}, {hex: '#FDEBD4', file_no: '09', name: 'White Chocolate', code: 'DS 129', dark: true}, {hex: '#FBD3B0', file_no: '10', name: 'Melon', code: 'DS 308', dark: true}, {hex: '#F1C89C', file_no: '11', name: 'Biscuit', code: 'DS 608', dark: true}, {hex: '#FBC5A1', file_no: '12', name: 'Sunset', code: 'DS 336', dark: true}, {hex: '#F9C19E', file_no: '13', name: 'Tropical Punch', code: 'DS 398', dark: true}, {hex: '#F8C2BB', file_no: '14', name: 'Sweet 16', code: 'DS 216', dark: true}, {hex: '#D2191F', file_no: '15', name: 'Bullseye', code: 'DS 275', dark: true}, {hex: '#D5DBCD', file_no: '16', name: 'Iceberg', code: 'DS 105', dark: true}, {hex: '#BBE0C1', file_no: '17', name: 'Urban Jungle', code: 'DS 907', dark: true}, {hex: '#B0C662', file_no: '18', name: 'Wasabi', code: 'DS 936', dark: true}, {hex: '#004427', file_no: '19', name: 'Amazon', code: 'DS 973', dark: true}, {hex: '#D6D6CE', file_no: '20', name: 'Cloud Nine', code: 'DS 193', dark: true}, {hex: '#CAB8CE', file_no: '21', name: 'Orchid', code: 'DS 803', dark: true}, {hex: '#AC96C4', file_no: '22', name: 'Spring Break', code: 'DS 878', dark: true}, {hex: '#A8C9D8', file_no: '23', name: 'Sky Light', code: 'DS 715', dark: true}, {hex: '#B2C7E6', file_no: '24', name: 'Lilac', code: 'DS 815', dark: true}, {hex: '#959FA1', file_no: '25', name: 'Concrete Gray', code: 'DS 178', dark: true}, {hex: '#668BA8', file_no: '26', name: 'Moonlight', code: 'DS 733', dark: true}, {hex: '#5C6670', file_no: '27', name: 'Almost Black', code: 'DS 153', dark: true}, {hex: '#214D70', file_no: '28', name: 'Deep Blue', code: 'DS 750', dark: true}, {hex: '#EFDB6B', file_no: '29', name: 'Summer Fun', code: 'DS 510', dark: true}, {hex: '#FDE528', file_no: '30', name: 'Sunrise', code: 'DS 555', dark: true}, {hex: '#FAB260', file_no: '31', name: 'Pot of Gold', code: 'DS 373', dark: true}, {hex: '#F78F50', file_no: '32', name: 'Orange County', code: 'DS 325', dark: true}, {hex: '#B87E58', file_no: '33', name: 'Caramel', code: 'DS 631', dark: true}, {hex: '#8D4A2D', file_no: '34', name: 'Fire Dance', code: 'DS 253', dark: true}],
      // tslint:disable-next-line:max-line-length
      elastofloor : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'ROS EF 1010', dark: true}, {hex: '#E1CAA8', file_no: '02', name: 'Beige', code: 'ROS EF 1993', dark: true}, {hex: '#B2BEBE', file_no: '03', name: 'Gray', code: 'ROS EF 1126', dark: true}, {hex: '#E8C11E', file_no: '04', name: 'Yellow', code: 'ROS EF 5050', dark: true}, {hex: '#D22127', file_no: '05', name: 'Red', code: 'ROS EF 2611', dark: true}, {hex: '#A94E2F', file_no: '06', name: 'Tile Red', code: 'ROS EF 4030', dark: true}, {hex: '#1E442B', file_no: '07', name: 'Green', code: 'ROS EF 9010', dark: true}, {hex: '#30469C', file_no: '08', name: 'Blue', code: 'ROS EF 7010', dark: true}, {hex: '#231F20', file_no: '09', name: 'Black', code: 'ROS EF 1130', dark: false}],
      // tslint:disable-next-line:max-line-length
      fresco : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'F300', dark: true}, {hex: '#FFFFFF', file_no: '02', name: 'Clean White', code: 'F130', dark: true}, {hex: '#E4E7DC', file_no: '03', name: 'Bio White', code: 'F183', dark: true}, {hex: '#E1E2D0', file_no: '04', name: 'Marble Gray', code: 'F125', dark: true}, {hex: '#D3E4A0', file_no: '05', name: 'Morning Breeze', code: 'F958', dark: true}, {hex: '#C2DFA9', file_no: '06', name: 'Rain Drop', code: 'F919', dark: true}, {hex: '#B9DBB6', file_no: '07', name: 'Green Tea', code: 'F988', dark: true}, {hex: '#1FB585', file_no: '08', name: 'Meadow', code: 'F930', dark: true}, {hex: '#FFF5DA', file_no: '09', name: 'Belgian Waffle', code: 'F179', dark: true}, {hex: '#FDF8D6', file_no: '10', name: 'Marshmallow', code: 'F165', dark: true}, {hex: '#F2F2DA', file_no: '11', name: 'Magnolia', code: 'F108', dark: true}, {hex: '#EAE1BA', file_no: '12', name: 'Muffin', code: 'F686', dark: true}, {hex: '#FEEBBC', file_no: '13', name: 'Sweet Mocha', code: 'F623', dark: true}, {hex: '#FEF7A2', file_no: '14', name: 'Buttermilk', code: 'F585', dark: true}, {hex: '#FEEFA1', file_no: '15', name: 'Mellow Yellow', code: 'F537', dark: true}, {hex: '#FBE484', file_no: '16', name: 'Lemonade', code: 'F529', dark: true}, {hex: '#FEC740', file_no: '17', name: 'Rise and Shine', code: 'F516', dark: true}, {hex: '#FBDFD3', file_no: '18', name: 'Cotton Candy', code: 'F628', dark: true}, {hex: '#FBC5A9', file_no: '19', name: 'Lollipop', code: 'F303', dark: true}, {hex: '#F5B5BB', file_no: '20', name: 'Bubblegum', code: 'F211', dark: true}, {hex: '#F2ADA6', file_no: '21', name: 'It\'s a Girl', code: 'F232', dark: true}, {hex: '#C4987D', file_no: '22', name: 'Hot Chocolate', code: 'F637', dark: true}, {hex: '#773E35', file_no: '23', name: 'Coffee', code: 'F658', dark: true}, {hex: '#A71B1E', file_no: '24', name: 'Hot Sauce', code: 'F219', dark: true}, {hex: '#DEDDEF', file_no: '25', name: 'Fresh Water', code: 'F812', dark: true}, {hex: '#C2AFCF', file_no: '26', name: 'Cool Morning', code: 'F865', dark: true}, {hex: '#877EB3', file_no: '27', name: 'By The Bay', code: 'F898', dark: true}, {hex: '#CBE8EC', file_no: '28', name: 'Bubble', code: 'F793', dark: true}, {hex: '#6FB0C2', file_no: '29', name: 'Cool Rain', code: 'F727', dark: true}, {hex: '#97B8E1', file_no: '30', name: 'Forget Me Not', code: 'F837', dark: true}, {hex: '#60A9D6', file_no: '31', name: 'It\'s a Boy', code: 'F760', dark: true}, {hex: '#4981BE', file_no: '32', name: 'Blue Moon', code: 'F711', dark: true}, {hex: '#D1D1D1', file_no: '33', name: 'Polished Rock', code: 'F158', dark: true}, {hex: '#A9A9A9', file_no: '34', name: 'Platinum', code: 'F113', dark: true}, {hex: '#5F6565', file_no: '35', name: 'Charcoal Gray', code: 'F137', dark: true}, {hex: '#010302', file_no: '36', name: 'Black', code: 'F311', dark: false}],
      // tslint:disable-next-line:max-line-length
      hi_gloss : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'HG 100', dark: true}, {hex: '#F6F6F6', file_no: '02', name: 'Adobe White', code: 'HG 128', dark: true}, {hex: '#DDE8E2', file_no: '03', name: 'Misty', code: 'HG 159', dark: true}, {hex: '#B6B6B6', file_no: '04', name: 'Ashly', code: 'HG 185', dark: true}, {hex: '#64635F', file_no: '05', name: 'Metal Gray', code: 'HG 172', dark: true}, {hex: '#FED430', file_no: '06', name: 'Solar Yellow', code: 'HG 519', dark: true}, {hex: '#D8954E', file_no: '07', name: 'Golden State', code: 'HG 630', dark: true}, {hex: '#9A632A', file_no: '08', name: 'Ginger Bread', code: 'HG 305', dark: true}, {hex: '#786346', file_no: '09', name: 'Brownies', code: 'HG 608', dark: true}, {hex: '#743A26', file_no: '10', name: 'Maple Leaf', code: 'HG 625', dark: true}, {hex: '#401C10', file_no: '11', name: 'Choco Brown', code: 'HG 673', dark: false}, {hex: '#D2191F', file_no: '12', name: 'Red Label', code: 'HG 229', dark: true}, {hex: '#B0C662', file_no: '13', name: 'Galaxy Green', code: 'HG 920', dark: true}, {hex: '#3C6731', file_no: '14', name: 'Crystal Green', code: 'HG 929', dark: true}, {hex: '#668BA8', file_no: '15', name: 'Cosmic Blue', code: 'HG 703', dark: true}, {hex: '#003555', file_no: '16', name: 'Crystal Blue', code: 'HG 753', dark: true}],
      // tslint:disable-next-line:max-line-length
      hydrolock : [{hex: '#FAFAF8', file_no: '01', name: 'White', code: 'HL 4000', dark: true}, {hex: '#EED0C6', file_no: '02', name: 'Pretty in Pink', code: 'HL 4201', dark: true}, {hex: '#F3C6A5', file_no: '03', name: 'Fantasy', code: 'HL 4303', dark: true}, {hex: '#FCCD8F', file_no: '04', name: 'Fresh Peach', code: 'HL 4300', dark: true}, {hex: '#C1A987', file_no: '05', name: 'Classic Beige', code: 'HL 4101', dark: true}, {hex: '#FEF091', file_no: '06', name: 'Canary Yellow', code: 'HL 4500', dark: true}, {hex: '#CAE1CF', file_no: '07', name: 'Ice Age', code: 'HL 4701', dark: true}, {hex: '#BCDDAE', file_no: '08', name: 'Jade', code: 'HL 4901', dark: true}, {hex: '#74C2CE', file_no: '09', name: 'Blue Eyes', code: 'HL 4700', dark: true}, {hex: '#9D9A93', file_no: '10', name: 'Slate Gray', code: 'HL 4110', dark: true}],
      // tslint:disable-next-line:max-line-length
      roofmastic : [{hex: '#FFFFFF', file_no: '01', name: 'White', code: 'RM 12000', dark: true}, {hex: '#B7A678', file_no: '02', name: 'Samar Beige', code: 'RM 12183', dark: true}, {hex: '#C7784D', file_no: '03', name: 'Terracotta', code: 'RM 12337', dark: true}, {hex: '#7E4921', file_no: '04', name: 'Tagaytay Brown', code: 'RM 12600', dark: true}, {hex: '#663112', file_no: '05', name: 'Red', code: 'RM 12222', dark: true}, {hex: '#4E2301', file_no: '06', name: 'Spanish Red', code: 'RM 12233', dark: false}, {hex: '#3D1201', file_no: '07', name: 'Choco Brown', code: 'RM 12603', dark: false}, {hex: '#CC191F', file_no: '08', name: 'Shanghai Red', code: 'RM 12200', dark: true}, {hex: '#009261', file_no: '09', name: 'Crystal Green', code: 'RM 12900', dark: true}, {hex: '#014327', file_no: '10', name: 'Baguio Green', code: 'RM 12911', dark: false}, {hex: '#006ea1', file_no: '11', name: ' Crystal Blue', code: 'RM 12733', dark: true}, {hex: '#014C83', file_no: '12', name: 'Azure Blue', code: 'RM 12777', dark: true}],
      // tslint:disable-next-line:max-line-length
      sunroof : [{hex: '#F9F9F9', file_no: '01', name: 'White', code: 'SR 100', dark: true}, {hex: '#D2E0CF', file_no: '02', name: 'Laguna White', code: 'SR 180', dark: true}, {hex: '#009166', file_no: '03', name: 'Crystal Green', code: 'SR 900', dark: true}, {hex: '#0176AC', file_no: '04', name: 'Crystal Blue', code: 'SR 733', dark: true}, {hex: '#005C7E', file_no: '05', name: 'Navy Blue', code: 'SR 700', dark: true}, {hex: '#005d90', file_no: '06', name: 'Azure Blue', code: 'SR 777', dark: true}, {hex: '#481759', file_no: '07', name: 'Purple Heart', code: 'SR 800', dark: true}, {hex: '#E1D4A0', file_no: '08', name: 'Creamy White', code: 'SR 187', dark: true}, {hex: '#D8D1A5', file_no: '09', name: 'Samar Beige', code: 'SR 183', dark: true}, {hex: '#C5BA8D', file_no: '10', name: 'Beige', code: 'SR 182', dark: true}, {hex: '#C3B260', file_no: '11', name: 'Tuscan Beige', code: 'SR 188', dark: true}, {hex: '#57762A', file_no: '12', name: 'Army Green', code: 'SR 933', dark: true}, {hex: '#00471B', file_no: '13', name: 'Baguio Green', code: 'SR 911', dark: false}, {hex: '#031603', file_no: '14', name: 'Wall Street', code: 'SR 150', dark: false}, {hex: '#D87443', file_no: '15', name: 'Terra Cotta', code: 'SR 337', dark: true}, {hex: '#E46437', file_no: '16', name: 'Rising Sun', code: 'SR 300', dark: true}, {hex: '#9E4D22', file_no: '17', name: 'Wood Bridge', code: 'SR 600', dark: true}, {hex: '#B84121', file_no: '18', name: 'Riviera Orange', code: 'SR 333', dark: true}, {hex: '#ED302A', file_no: '19', name: 'Holiday Red', code: 'SR 200', dark: true}, {hex: '#851511', file_no: '20', name: 'Crimson Red', code: 'SR 222', dark: true}, {hex: '#5D0209', file_no: '21', name: 'Spanish Red', code: 'SR 233', dark: false}, {hex: '#330007', file_no: '22', name: 'Choco Brown', code: 'SR 603', dark: false}],
      // tslint:disable-next-line:max-line-length
      wallmastic : [{hex: '#FCEDE6', file_no: '01', name: 'Snow Flake', code: 'WM 6101', dark: true}, {hex: '#FEF2D9', file_no: '02', name: 'White Sand', code: 'WM 6103', dark: true}, {hex: '#F8EDCF', file_no: '03', name: 'Lion Heart', code: 'WM 6102', dark: true}, {hex: '#E7CDB4', file_no: '04', name: 'Bamboo', code: 'WM 6104', dark: true}, {hex: '#D8BA96', file_no: '05', name: 'Atlas Beige', code: 'WM 6105', dark: true}, {hex: '#85633D', file_no: '06', name: 'Havana', code: 'WM 6400', dark: true}, {hex: '#E4E7DC', file_no: '07', name: 'Tulle WHite', code: 'WM 6100', dark: true}, {hex: '#EBE6EC', file_no: '08', name: 'Shy Violet', code: 'WM 6800', dark: true}, {hex: '#C3E0DE', file_no: '09', name: 'Galaxy Blue', code: 'WM 6701', dark: true}, {hex: '#8D9D9D', file_no: '10', name: 'Titanium', code: 'WM 6110', dark: true}, {hex: '#85908A', file_no: '11', name: 'Steel Gray', code: 'WM 6112', dark: true}, {hex: '#5A686B', file_no: '12', name: 'Carbon Fiber', code: 'WM 6111', dark: true}, {hex: '#4073A8', file_no: '13', name: 'Blue Star', code: 'WM 6700', dark: true}, {hex: '#FBDF00', file_no: '14', name: 'Yellow Ribbon', code: 'WM 6500', dark: true}, {hex: '#F78F2C', file_no: '15', name: 'Majestic Orange', code: 'WM 6300', dark: true}, {hex: '#BF2420', file_no: '16', name: 'Fireworks', code: 'WM 6200', dark: true}, {hex: '#678046', file_no: '17', name: 'Evergreen', code: 'WM 6900', dark: true}],
    };
    this.colorsSearch = [
